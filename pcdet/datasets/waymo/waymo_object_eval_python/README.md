# waymo-object-eval-python
**Note**: This is borrowed from [traveller59/waymo-object-eval-python](https://github.com/traveller59/waymo-object-eval-python)

Fast waymo object detection eval in python(finish eval in less than 10 second), support 2d/bev/3d/aos. , support coco-style AP. If you use command line interface, numba need some time to compile jit functions.
## Dependencies
...
dt_annos = waymo.get_label_annos(det_path)
...
gt_annos = waymo.get_label_annos(gt_path, val_image_ids)
