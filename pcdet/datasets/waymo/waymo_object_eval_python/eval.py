...
def calculate_iou_partly(gt_annos, dt_annos, metric, num_parts=50):
    ...
    Args:
        gt_annos: dict, must from get_label_annos() in waymo_common.py
        dt_annos: dict, must from get_label_annos() in waymo_common.py
...
def eval_class(gt_annos,
               ...
               compute_aos=False,
               num_parts=100):
    """waymo eval. support 2d/bev/3d/aos eval. support 0.5:0.05:0.95 coco AP.
    Args:
        gt_annos: dict, must from get_label_annos() in waymo_common.py
        dt_annos: dict, must from get_label_annos() in waymo_common.py
