...
def get_image_path(idx, prefix, training=True, relative_path=True):
    return get_waymo_info_path(idx, prefix, 'image_2', '.png', training,
                               relative_path)


def get_label_path(idx, prefix, training=True, relative_path=True):
    return get_waymo_info_path(idx, prefix, 'label_2', '.txt', training,
                               relative_path)


def get_velodyne_path(idx, prefix, training=True, relative_path=True):
    return get_waymo_info_path(idx, prefix, 'velodyne', '.bin', training,
                               relative_path)


def get_calib_path(idx, prefix, training=True, relative_path=True):
    return get_waymo_info_path(idx, prefix, 'calib', '.txt', training,
                               relative_path)
...
def filter_waymo_anno(image_anno,
                      used_classes,
...
def waymo_result_line(result_dict, precision=4):
