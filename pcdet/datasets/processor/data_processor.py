...
class DataProcessor(object):
    ...
    def mask_points_and_boxes_outside_range_AYDIV(self, data_dict=None, config=None):
        if data_dict is None:
            return partial(self.mask_points_and_boxes_outside_range_AYDIV, config=config)
    ...
    def shuffle_points_AYDIV(self, data_dict=None, config=None):
        if data_dict is None:
            return partial(self.shuffle_points_AYDIV, config=config)
