...
def boxes3d_waymo_camera_to_lidar(boxes3d_camera, calib):
    """
    Args:
...
def boxes3d_waymo_fakelidar_to_lidar(boxes3d_lidar):
    """
    Args:
...
def boxes3d_waymo_lidar_to_fakelidar(boxes3d_lidar):
    """
    Args:
...
def boxes3d_lidar_to_waymo_camera(boxes3d_lidar, calib):
    """
...
def boxes3d_to_corners3d_waymo_camera(boxes3d, bottom_center=True):
    """
    :param boxes3d: (N, 7) [x, y, z, l, h, w, ry] in camera coords, see the definition of ry in waymo dataset
...
def boxes3d_waymo_camera_to_imageboxes(boxes3d, calib, image_shape=None):
    """
    ...
    """
    corners3d = boxes3d_to_corners3d_waymo_camera(boxes3d)
