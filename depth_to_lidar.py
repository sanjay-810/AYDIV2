...
def depth_to_lidar(idx_filename, split, dense_depth_dir, pseudo_depth_dir):
    dataset = waymo_object('data/waymo_aydiv_seguv_twise', split)
...
depth_to_lidar( \
    'data/waymo_aydiv_seguv_twise/ImageSets/trainval.txt',
    'training',
    'data/waymo_aydiv_seguv_twise/training/depth_dense_twise',
    'data/waymo_aydiv_seguv_twise/training/depth_pseudo_rgbseguv_twise'
)

print('---------------Start to generate testing pseudo point clouds---------------')
depth_to_lidar( \
    'data/waymo_aydiv_seguv_twise/ImageSets/test.txt',
    'testing',
    'data/waymo_aydiv_seguv_twise/testing/depth_dense_twise',
    'data/waymo_aydiv_seguv_twise/testing/depth_pseudo_rgbseguv_twise'
)