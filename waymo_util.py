""" Helper methods for loading and parsing waymo data.
...
class Calibration(object):
    ''' Calibration matrices and utils
        ...
        Ref (waymo paper): http://www.cvlibs.net/publications/Geiger2013IJRR.pdf
    ...
    def read_calib_file(self, filepath):
        ...
        Ref: https://github.com/utiasSTARS/pywaymo/blob/master/pywaymo/utils.py
        '''
        data = {}
